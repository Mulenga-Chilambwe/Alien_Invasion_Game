...
def check_events( ai_settings, screen, stats, play_button, ship,aliens, bullets):
    """Respond to keyrames and mouse events."""
...
def check_play_button( ai_settings, screen, stats, play_button, ship, aliens,bullets, mouse_x, mouse_y):
    """Stats a new game when the player clicks play."""
    button_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
    if button_clicked and not stats.game_active:
        # reset the game settings 
        ai_settings.initialize_dynamic_setting()
        
        # Hide teh mouse cursor.
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    #Redraw the images on the screen and flip to the new screen 
...
def update_bullets( ai_settings, screen, stats, sb, ship, aliens, bullets):
        ...
        # call the function which checks if theres collison alien and the bullet.
...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    if stats.ship_left > 0:
       ...
       # empty the list of aliens and bulltets '
       aliens.empty()
       bullets.empty()
